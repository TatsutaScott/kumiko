 ...
 */
function asanoha_pattern(x, y, w, h, cols, rot = 0) {
 ...
 * @void
 */
function asanoha_hexagon(x, y, rad, rot) {
  push();
  translate(x, y);
  rotate(rot);
  ...
  for (let i = 0; i < 6; i++) {
    ...
    asanoha_triangle(pos.x, pos.y, triangle_radius, theta + PI);
  }
 ...
 * @void
 */
function asanoha_triangle(x, y, rad, rot) {
  const points = [];
